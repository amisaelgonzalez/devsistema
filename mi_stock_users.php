		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="div-action pull pull-right" style="padding-bottom:20px;">
					<button class="btn btn-default button1" onclick="addProducto();" data-toggle="modal" id="addMiStockModalBtn" data-target="#addMiStockModal"> <i class="glyphicon glyphicon-plus-sign"></i> Agregar producto </button>
				</div> <!-- /div-action -->				
...
<script src="custom/js/miStockUsers.js"></script>

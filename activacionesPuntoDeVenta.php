...
<script src="custom/js/activacionesPuntoDeVenta.js"></script>
	      	...
	      	<div class="modal-body" style="max-height:450px; overflow:auto;">
				...
				<div class="div-loading">
	      		...
	      		<div class="div-result">
				 			...
				 			<form class="form-horizontal" id="editUsertForm" action="php_action/pdv/editClientPuntoDeVentaDelete.php" method="POST">
				 				<br />
	      	...
	      	<div class="modal-body" style="max-height:450px; overflow:auto;">
				...
				<div class="div-loading">
	      		...
	      		<div class="div-result">
				 			...
				 			<form class="form-horizontal" id="editProducttForm" action="php_action/pdv/editProductPuntoDeVentaDelete.php" method="POST">
				 				<br />

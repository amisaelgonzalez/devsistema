...
//$data = "SELECT * FROM orders_pdv WHERE tipo_orden = 2 AND id_order = $orderId";
			...
			<table class="table" id="productTable">
			  	...
			  	<tbody>
			  		...
			  		$orderItemSql = "SELECT orders_detalle.order_detalle_id, orders_detalle.order_id, orders_detalle.product_id, orders_detalle.cantidad, 
			  								orders_detalle.precio, orders_detalle.total FROM orders_detalle_pdv as orders_detalle WHERE orders_detalle.order_id = {$orderId}";
				  		...
				  		<tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">
							...
							<td style="margin-left:20px;">
				  			...
				  			<td style="padding-left:20px;">
				  				<div class="form-group">
				  					<?php
			  							//$productSql = "SELECT * FROM product_pdv WHERE estado = 1 AND cantidad != 0";
				  						$productSql = "SELECT * FROM product_pdv ";
...
<script src="custom/js/editPuntoDeVenta.js?ver=1.0.35"></script>

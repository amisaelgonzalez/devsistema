...
<script src="custom/js/clientPuntoDeVenta.js"></script>
	      	...
	      	<div class="modal-body" style="max-height:450px; overflow:auto;">
				...
				<div class="div-loading">
	      		...
	      		<div class="div-result">
				 			...
				 			<form class="form-horizontal" id="editClientForm" action="php_action/pdv/editClientPuntoDeVenta.php" method="POST">
				 				<br />
...
<div class="modal fade" data-backdrop="static" data-keyboard="false" id="addClientModal" tabindex="-1" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form class="form-horizontal" id="submitClientForm" action="php_action/pdv/createClientPuntoDeVenta.php" method="POST" enctype="multipart/form-data">
				<div class="modal-header">
				    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>

...
<h4>
	...
	<?php if($_GET['o'] == 'add') {
		echo "Agregar Cr&eacute;dito";
	} else if($_GET['o'] == 'manord') { 
		echo "Listado de cr&eacute;ditos";
	} else if($_GET['o'] == 'editOrd') { 
		echo "Editar orden";
	}
	?>	
...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<?php if($_GET['o'] == 'add') { ?>
  		<i class="glyphicon glyphicon-plus-sign"></i>	Agregar Cr&eacute;dito
		<?php } else if($_GET['o'] == 'manord') { ?>
			<i class="glyphicon glyphicon-edit"></i> Listado de Cr&eacute;ditos
		<?php } else if($_GET['o'] == 'editOrd') { ?>
			<i class="glyphicon glyphicon-edit"></i> Editar Cr&eacute;dito
		<?php } ?>
	...
	<div class="panel-body">
		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrderUsers.php" id="createOrderForm">
			  ...
			  <div class="form-group">
			    <label for="clientName" class="col-sm-2 control-label">Nombre completo </label>
			    <div class="col-sm-10">
			  ...
			  <div class="form-group">
			    <label for="clientContact" class="col-sm-2 control-label">Teléfono </label>
			    <div class="col-sm-10">
			  ...
			  <div class="form-group">
			    <label for="colina" class="col-sm-2 control-label">Colina </label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="colina" name="colina" autocomplete="off" />
			    </div>
			  </div> <!--/form-group-->
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group">
				    <label for="paymentType" class="col-sm-4 control-label">Método de pago</label>
				    <div class="col-sm-8">
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/editOrderUsers.php" id="editOrderForm">
			  ...
			  <div class="form-group">
			    <label for="colina" class="col-sm-2 control-label">Colina </label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="colina" name="colina" autocomplete="off" value="<?php echo $data[13] ?>"/>
			    </div>
			  </div> <!--/form-group-->
			  ...
			  <div class="form-group">
			    <label for="calle" class="col-sm-2 control-label">Calle </label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="calle" name="calle" autocomplete="off" value="<?php echo $data[14] ?>"/>
			    </div>
			  </div> <!--/form-group-->
			  ...
			  <div class="form-group">
			    <label for="ciudad" class="col-sm-2 control-label">Ciudad </label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="ciudad" name="ciudad" autocomplete="off" value="<?php echo $data[15] ?>"/>
			    </div>
			  </div> <!--/form-group-->	
    ...
    <div class="modal-content">
      ...
      <div class="modal-body form-horizontal" style="max-height:500px; overflow:auto;" >
      	...
      	<div class="paymentOrderMessages"></div>
			  ...
			  <div class="form-group">
			    <label for="paymentType" class="col-sm-3 control-label">Método de pago</label>
			    <div class="col-sm-9">
			      <select class="form-control" name="paymentType" id="paymentType" >
			      	<option value=""> -- Selecciona -- </option>
			      	<option value="1">Cheque</option>
			  ...
			  <div class="form-group">
			    <label for="paymentStatus" class="col-sm-3 control-label">Estado</label>
			    <div class="col-sm-9">
			      <select class="form-control" name="paymentStatus" id="paymentStatus">
			      	<option value="">-- Selecciona --</option>
			      	<option value="1">Pago completo</option>
...
<script src="custom/js/orderUsers.js?ver=1.0.1"></script>

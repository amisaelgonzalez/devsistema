...
<script src="custom/js/productPuntoDeVenta.js?ver=1.0.10"></script>
					...
					<!-- Tab panes -->
				 	<div class="tab-content">
				 		...
				 		<div role="tabpanel" class="tab-pane active" id="photo">
				 			<form action="php_action/pdv/editProductPuntoDeVentaImage.php" method="POST" id="updateProductImageForm" class="form-horizontal" enctype="multipart/form-data">
				 				<br />
						...
						<!-- Información Producto -->
				 		<div role="tabpanel" class="tab-pane" id="productInfo">
				 			<form class="form-horizontal" id="editProductForm" action="php_action/pdv/editProductPuntoDeVenta.php" method="POST">
				 				<br />
...
<div class="modal fade" data-backdrop="static" data-keyboard="false" id="addProductModal" tabindex="-1" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form class="form-horizontal" id="submitProductForm" action="php_action/pdv/createProductPuntoDeVenta.php" method="POST" enctype="multipart/form-data">
				<div class="modal-header">
				    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>

...
if($_POST) {
	...
	$sql = "UPDATE product_pdv SET nombre = '$productName', costo = '$costo',  precio = '$precio', plata = '$plata', bronce = '$bronce', marca = '$marca', cantidad = '$stock', genero = '$gender',  status = '$productStatus' 

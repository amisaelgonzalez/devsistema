...
if($result->num_rows > 0) {
	...
	$countOrderItemSql = "SELECT count(*) FROM orders_detalle_pdv WHERE order_id = $orderId";
 	$itemCountResult = $connect->query($countOrderItemSql);
 	$itemCountRow = $itemCountResult->fetch_row();

 	//Consulta para sumar el total de productos adquiridos por especie en total

 	/*$sumProduct = "SELECT sum(cantidad) FROM orders_detalle_pdv WHERE order_id = $orderId";
	...
	$button = '<!-- Single button -->
					<div class="btn-group">
						...
						<ul class="dropdown-menu">
							<li><a href="editPuntoDeVenta.php?id='.$orderId.'"" type="button" > <i class="glyphicon glyphicon-edit"></i> Editar</a></li>

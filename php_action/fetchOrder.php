...
$sql = "SELECT o.order_id, o.fecha_add, s.sucursales_name, o.client_contact, o.payment_status FROM orders o INNER JOIN sucursales s ON s.sucursales_id = o.client_name WHERE o.order_status = 1";

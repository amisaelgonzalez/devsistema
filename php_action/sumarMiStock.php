...
if($_POST) {
	...
	$user_id = $_SESSION['userId'];
  	...
  	$sqlPs = "SELECT product_id, product_name, product_image, brand_id, categories_id, quantity, price_mayoreo, rate, active, status FROM product WHERE product_id = $miStockId";
	...
	$sqlupd = "UPDATE product SET quantity = quantity-'$cantidad' WHERE product_id = $miStockId";

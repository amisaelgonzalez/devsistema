 ...
 while($row = $result->fetch_array()) {
	...
	<div class="btn-group">
	  ...
	  <ul class="dropdown-menu">
	    <li><a type="button" data-toggle="modal" id="descontarMiStockModalBtn" data-target="#descontarMiStockModal" onclick="descontarMiStock('.$productId.')"> <i class="glyphicon glyphicon-edit"></i>Agregar a mi stock</a></li>      
	  </ul>
	</div>';

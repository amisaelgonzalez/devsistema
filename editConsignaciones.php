...
//$data = "SELECT * FROM orders_pdv WHERE tipo_orden = 1 AND id_order = $idOrder";
			...
			<table class="table" id="productTable">
			  	...
			  	<tbody>
			  		...
			  		$orderItemSql = "SELECT orders_detalle.order_detalle_id, orders_detalle.order_id, orders_detalle.product_id, orders_detalle.cantidad, 
			  								orders_detalle.precio, orders_detalle.total FROM orders_detalle_pdv as orders_detalle WHERE orders_detalle.order_id = {$idOrder}";
...
<script src="custom/js/editPuntoDeVenta.js"></script>

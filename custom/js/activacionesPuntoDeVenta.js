...
$(document).ready(function() {
	...
	actCteTable = $('#actCteTable').DataTable({
		'ajax': 'php_action/pdv/fetchCteDelete.php',
		'order': []
	});
	// manage user data table
	actProducTable = $('#actProducTable').DataTable({
		'ajax': 'php_action/pdv/fetchCtePuntoDeVentaDelete.php',
		'order': []
	});
...
/*function activarCte(cteId = null) {
	...
	if (cteId) {
		...
		$.ajax({
			url: 'php_action/pdv/fetchSelectedCtePuntoDeVentaDelete.php',
			type: 'post',
			data: {cteId: cteId},
			dataType: 'json',
...
function activarProduct(prodId = null) {
	...
	if (prodId) {
		...
		$.ajax({
			url: 'php_action/pdv/fetchSelectedProdPuntoDeVentaDelete.php',
			type: 'post',
			data: {prodId: prodId},
			dataType: 'json',
			success:function(response) {		

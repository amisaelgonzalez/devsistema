...
$(document).ready(function() {
	...
	} else if(divRequest == 'calendarEvent') {
		// top nav child bar 
		var idFilter = $('#idOrdersFilter').text();
		manageOrderTable = $("#manageOrderTable2").DataTable({
			'ajax': 'php_action/fetchOrderById.php?id='+idFilter,
			'order': []
		});		
...
function paymentOrder(orderId = null) {
	...
	function filtarVenta() {
		...
		var id = $('#selectid').val();
		console.log(id);
		window.location.href = "orders.php?o=manord&user_id="+id;
	}

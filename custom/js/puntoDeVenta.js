			...
			if(validateProduct == true && validateQuantity == true) {
					...
					$.ajax({
						...
						success:function(response) { 
			            	...
			            	' <br /> <br /> <a href="gestionPuntoDeVenta.php" class="btn btn-primary"> <i class="glyphicon glyphicon-print"></i> Imprimir </a>'+
			            	'<a href="puntoDeVenta.php?o=add" class="btn btn-default" style="margin-left:10px;"> <i class="glyphicon glyphicon-plus-sign"></i> Agregar nueva orden </a>'+
...
function addRow(){
	...
	$.ajax({
		url: 'php_action/pdv/fetchProductPuntoDeVentaData.php',
		type: 'post',
		dataType: 'json',
		success:function(response) {
...
function getProductData(row = null){
	...
	if (row) {
		...
		if(productId == "" ){
			...
			$.ajax({
				url: 'php_action/pdv/fetchSelectedProductPuntoDeVenta.php',
				type: 'post',
...
function getClientData(){
		...
		if(clientId == "" ){
			...
			$.ajax({
				url: 'php_action/pdv/fetchSelectedClientPuntoDeVenta.php',
				type: 'post',

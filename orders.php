...
} else if($_GET['o'] == 'calendarEvent') { 
	echo "<div class='div-request div-hide'>calendarEvent</div>";
	echo "<div id='idOrdersFilter' class='div-hide'>".$_GET['id']."</div>";
...
<ol class="breadcrumb">
  ...
  <li class="active">
  	<?php if($_GET['o'] == 'add') { ?>
		...
		<?php } else if($_GET['o'] == 'calendarEvent') {
			echo $_GET['id'];
		} else if($_GET['o'] == 'editOrd') { ?>
	...
	<div class="panel-body">
		...
		<?php } else if($_GET['o'] == 'calendarEvent') { 
			...
			<div class="div-action pull pull-right" style="padding-bottom:20px;">
				<button class="btn btn-default button1" data-toggle="modal" data-target="#addBrandModel"><a style="color: #333;text-decoration: none;" href="orders.php?o=manord"><i class="glyphicon glyphicon-list-alt""></i> Ver listado completo </a></i>  </button>
			</div> <!-- /div-action -->		
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/editOrder.php" id="editOrderForm">
  			...
  			$sql = "SELECT orders.order_id, orders.order_date, orders.client_name, orders.client_contact, orders.sub_total, orders.vat, orders.total_amount, orders.discount, orders.grand_total, orders.paid, orders.due, orders.payment_type, orders.payment_status, orders.fecha_add, orders.hora_add FROM orders 	
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="fecha_add" name="fecha_add" autocomplete="off" value="<?php echo $data[13] ?>" disabled/>
			    </div>
			  </div> <!--/form-group-->
